...
const payWithStripe = async (req:Request,res:Response) => {
    try {
            ...
            line_items: [
                {
                    price_data:{
                        currency: "inr",
                        product_data: {
                            name: "HungryEats food order webapp",
                        },
...
export { createRazorpayOrder, verifyRazorPayment, payWithStripe, verifyStripe };