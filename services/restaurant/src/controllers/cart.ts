...
const addToCart = TryCatch(async (req:AuthenticatedRequest,res) => {
...
const fetchMyCart = TryCatch(async (req:AuthenticatedRequest,res) => {
...
const incrementCartItem = TryCatch(async (req:AuthenticatedRequest,res) => {
...
const decrementCartItem = TryCatch(async (req:AuthenticatedRequest,res) => {
...
const clearCart = TryCatch(async (req:AuthenticatedRequest,res) => {
...
export { addToCart, fetchMyCart, incrementCartItem, decrementCartItem, clearCart };